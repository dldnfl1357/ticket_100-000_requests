...
**100,000 TPS + 에러 0% + 응답 시간 3초 이내**를 목표로 하는 고가용성 티켓 예매 서버

## 📊 성능 지표

| 항목 | 목표           | 현재 달성 | 상태 |
|------|--------------|----------|------|
| **처리 시간** | 3초 이내        | **3.5초** | ⚠️ 0.5초 차이 |
| **처리량 (TPS)** | 33,333 TPS   | **28,571 TPS** | 🔄 개선 중 |
| **에러율** | 0%           | **0%** | ✅ 달성 |
| **정확성** | 50,000개 정확 예약 | **50,000개** | ✅ 달성 |
| **동시성** | 중복 예약 방지     | **완벽 방지** | ✅ 달성 |

**최종 성능**: 100,000개 메시지를 **평균 3.5초**에 처리 (28,571 TPS)
